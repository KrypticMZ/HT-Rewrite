package me.htrewrite.phobosimports;
...
public class RenderUtil {
    ...
    public static void drawText(BlockPos pos, String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate((double)(-((double)mc.fontRenderer.getStringWidth(text) / 2.0)), (double)0.0, (double)0.0);
    ...
    public static void blockEsp(BlockPos blockPos, Color c, double length, double length2) {
        double x = (double)blockPos.getX() - RenderUtil.mc.getRenderManager().renderPosX;
        double y = (double)blockPos.getY() - RenderUtil.mc.getRenderManager().renderPosY;
        double z = (double)blockPos.getZ() - RenderUtil.mc.getRenderManager().renderPosZ;
        GL11.glPushMatrix();
    ...
    public static void drawSphere(double x, double y, double z, float size, int slices, int stacks) {
        ...
        GL11.glTranslated((double)(x - RenderUtil.mc.getRenderManager().renderPosX), (double)(y - RenderUtil.mc.getRenderManager().renderPosY), (double)(z - RenderUtil.mc.getRenderManager().renderPosZ));
