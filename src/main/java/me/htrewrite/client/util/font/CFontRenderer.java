...
public class CFontRenderer extends FontRenderer {
    ...
    public CFontRenderer(final Font font, final boolean antiAlias, final int charOffset) {
     ...
     * Make dis
     */
    private String toRandom(final CFont font, final String text)
    {
        String newText = "";
                        ...
                        final int charOffset)
    {
        synchronized(this)
        {
            ...
            boldFont = new CFont(font.deriveFont(Font.BOLD), antiAlias,
                    charOffset);
            italicFont = new CFont(font.deriveFont(Font.ITALIC), antiAlias,
                    charOffset);
            boldItalicFont =
                    new CFont(font.deriveFont(Font.BOLD | Font.ITALIC),
