...
import me.htrewrite.client.customgui.fontrenderer.HFontRenderer;
...
public class SplashProgressGui {
    ...
    // Font renderer
    private static HFontRenderer raleway;
    private static HFontRenderer roboto;
    ...
    private static void drawProgress() {
        ...
        if (raleway == null) raleway = new HFontRenderer("Raleway", 20);
        if (roboto == null) roboto = new HFontRenderer("Roboto", 20);
