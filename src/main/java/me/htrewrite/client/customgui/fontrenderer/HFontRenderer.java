package me.htrewrite.client.customgui.fontrenderer;
...
public class HFontRenderer {
    ...
    public HFontRenderer(String fontName, float fontSize) {
        name = fontName;
        size = fontSize;
    ...
    public HFontRenderer(String fontName, int fontType, int size) {
    ...
    private Font getFontFromInput(String path) throws IOException, FontFormatException {
        return Font.createFont(Font.TRUETYPE_FONT, HFontRenderer.class.getResourceAsStream(path));
    }
