package me.htrewrite.oyveyimports.util;
...
public class EntityUtil {
    ...
    public static boolean isntValid(final Entity entity, final double range) {
        return entity == null || isDead(entity) || entity.equals((Object)EntityUtil.mc.player) || (entity instanceof EntityPlayer && HTRewrite.INSTANCE.getFriendManager().isFriend(entity.getName())) || EntityUtil.mc.player.getDistanceSq(entity) > Math.square(range);
    }*/
    ...
    public static Color getColor(final Entity entity, final int red, final int green, final int blue, final int alpha, final boolean colorFriends) {
        ...
        if (entity instanceof EntityPlayer && colorFriends && HTRewrite.INSTANCE.getFriendManager().isFriend(((EntityPlayer)entity).getName())) {
